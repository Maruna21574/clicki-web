export const netacadUniza = {
  ...
  services: [
    "Kompletný dizajn a UX/UI návrh",
    "Programovanie frontendu aj backendu",
    "SEO optimalizácia",
    "Generovanie mailov",
    "Kontaktné formuláre",
    "Podpora a rozvoj webu"
  ],
  highlights: [
    "Moderný dizajn a prehľadné rozhranie",
    "Integrácia s e-learningom",
    "Praktické zručnosti a certifikácie Cisco",
    "Moderné laboratóriá a skúsení inštruktori"
  ],
  forWhom: [
